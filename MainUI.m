    ...
    methods
        function obj = MainUI(varargin)
            ...
            obj.guihandles.menu_file_f1=uimenu(obj.guihandles.menu_file,'Text','Image Load','Accelerator','L',...
                'UserData',struct('row',0,'col',0,'slice',0,'magnification',[],'pixelsize',[],'stepsize',[],'threeDdata',[],'binsize',[],'roi',struct('L',[],'T',[],'R',[],'B',[])));
            %%%%%%%%%%%%%%%%%%%%%% PSF raw data %%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function tifstackread(hObject,src,event, obj)
            ...
            bin_size=uicontrol(pararead,'Style','text','Units','normalized',...
                'String','Bin size(pixel)','Fontsize',10,...
            ...
            bin_size_in=uicontrol(pararead,'Style','edit','Units','normalized',...
                'Tag','bin_size','FontSize',10,'String',binsize,'Position',[0.55,0.37,0.3,0.1]);
